...
from applications.core.midjourney.service.template_controller import TemplateController
...
from applications.core.midjourney.wss.mj_wss_manager import MjWssManager
